...
# Entropie-Berechnung mit Counter
...
def main():
  ...
  print(f"{Fore.CYAN}[{args.hostname}] Workers: {args.workers}")
  if args.logfile:
  ...
  if args.csv and results:
      ...
      # FIX: os.path.dirname statt os.dirname (AttributeError-Bug)
